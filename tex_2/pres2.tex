...
\subsection*{ET Стьюдент отличие по сдвигу}
...
\begin{frame}{Выводы}
    \begin{enumerate}
        ...
        \begin{itemize}
            \item В случае распределения Коши эмпирические мощности $\text{ET}_2$ хорошо приближаются асимптотическими, хотя приведенная теорема этого не гарантирует.
        \end{itemize}
    \end{enumerate}
\end{frame}
